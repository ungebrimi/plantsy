import {ChatBubbleBottomCenterIcon, ChevronRightIcon} from '@heroicons/react/20/solid'
...
const links = [
    ...
    { name: 'News', href: '#', description: 'Check our latest news', icon: RssIcon },
]
    ...
    return (
            <main className="mx-auto w-full max-w-7xl px-6 pb-16 pt-10 sm:pb-24 lg:px-8">
                ...
                <div className="mx-auto mt-20 max-w-2xl text-center sm:mt-24">
                    ...
                    <h1 className="mt-4 text-3xl font-bold tracking-tight text-gray-900 sm:text-5xl">Authorization error</h1>
                    <p className="mt-4 text-base leading-7 text-gray-600 sm:mt-6 sm:text-lg sm:leading-8">
                        Sorry, we have encountered an issue authorizing your request. Please try again later.
