  ...
  return (
    <main>
      <div className="flex min-h-full flex-1 flex-col justify-center py-12 sm:px-6 lg:px-8">
        <section id="#cookie policy" className="max-w-7xl mx-auto mt-12">
          ...
          <h2 className="text-xl font-bold mt-8">What are cookies?</h2>
          <p className="text-lg">
          ...
          <h2 className="text-xl font-bold mt-8">How we use cookies</h2>
          <p className="text-lg">
            We use cookies to analyze website traffic, personalize content, and
            improve your experience on our website. We may also use cookies to
            remember your preferences and tailor the website to your interests.
          </p>
          <h2 className="text-xl font-bold mt-8">Managing cookies</h2>
          <p className="text-lg">
            You can manage cookies through the settings of your web browser.
        ...
        <section className="mt-12 mx-auto max-w-7xl" id="#terms-and-conditions">
          ...
          <p className="text-lg">
            ...
            address, when you interact with our website or provide it
            voluntarily.
          </p>
          <h2 className="text-xl font-bold mt-8">2. Information Usage</h2>
          <p className="text-lg">
            We may use the information we collect for various purposes, such as
            providing and improving our services, personalizing your experience,
            and communicating with you.
          </p>
          <h2 className="text-xl font-bold mt-8">3. Information Sharing</h2>
          <p className="text-lg">
          ...
          <p className="text-lg">
            ...
            maintain data security. However, please note that no method of
            transmission over the internet or electronic storage is 100% secure.
          </p>
          <h2 className="text-xl font-bold mt-8">5. External Links</h2>
          <p className="text-lg">
          ...
          <h2 className="text-xl font-bold mt-8">6. Changes to This Policy</h2>
          <p className="text-lg">
        ...
        <section className="mt-12 mx-auto max-w-7xl" id="privacy-policy">
          <h2 className="text-2xl font-bold mb-4">Terms and conditions</h2>
          <h2 className="text-xl font-bold">1. Acceptance of Terms</h2>
          <p className="text-lg">
            By accessing or using this website, you agree to be bound by these
            Terms and Conditions, as well as all applicable laws and
          ...
          <p className="text-lg">
            ...
            website owner and is protected by intellectual property laws.
          </p>
          <h2 className="text-xl font-bold mt-8">3. User Conduct</h2>
          <p className="text-lg">
            When using this website, you agree to comply with all applicable
            laws and regulations and to not engage in any illegal or harmful
            activities. You are solely responsible for your actions and any
            content you post on this site.
          </p>
          <h2 className="text-xl font-bold mt-8">
            4. Disclaimer of Warranties
          </h2>
          <p className="text-lg">
            This website is provided on an {'"'}as is{'"'} basis. The website
            owner makes no warranties or representations, expressed or implied,
            regarding the accuracy, reliability, or suitability of the content
            on this site.
          </p>
          <h2 className="text-xl font-bold mt-8">5. Limitation of Liability</h2>
          <p className="text-lg">
            The website owner shall not be liable for any damages arising out of
            the use or inability to use this website, including but not limited
          ...
          <p className="text-lg">
            ...
            proceeding arising out of these terms shall be subject to the
