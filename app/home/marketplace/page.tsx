                      ...
                      <div className="mt-2">
                        <p className="text-gray-500">
                          <span className="inline-block text-sm">
                            ...
                            <span className="inline-block relative top-0.5 ml-1">
                        ...
                        <p className="text-gray-500">
                          <span className="inline-block text-sm">
                            <ChatBubbleLeftIcon className="h-4 w-4 inline-block" />{" "}
                            <span className="inline-block relative top-0.5 ml-1">
                              Response in about <strong>2 hours</strong>
                            </span>
                          </span>
                        </p>
                      </div>
                      <p className="text-gray-500 mt-4 text-sm bg-slate-100 p-2">
                        Dani G. says, Highly recommended for someone looking for
                        a good <span className="font-semibold">handyman</span>
